...
find_pos = line.find(marker)

len_marker = len(marker)

#print(line[find_pos:find_pos+len_marker])

line_front = line[:find_pos]

line_back = line[find_pos+len_marker:]

#print(line_back)

replaced = line_front + replacement + line_back
